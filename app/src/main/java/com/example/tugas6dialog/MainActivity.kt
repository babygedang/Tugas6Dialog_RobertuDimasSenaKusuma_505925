...
import com.example.tugas6dialog.R
import com.example.tugas6dialog.databinding.ActivityMainBinding
...
class MainActivity() : AppCompatActivity(), Parcelable {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            kalender.setOnDateChangeListener { _, year, month, day ->
                daySave = day
                monthSave = month
                yearSave = year
            }
            ...
            spinnerAbsen.adapter = adapterAbsensi
            ...
            spinnerAbsen.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
